...
_baseClassParametersToExport = ["files","character","impact","soundEnviron","soundHit","grassCover","lucidity","dust","rough","surfaceFriction","maxSpeedCoef"];
_baseClassParametersToExport = _baseClassParametersToExport + ["isWater","maxClutterColoringCoef","transparency","restitution","friction","tracksAlpha"];
