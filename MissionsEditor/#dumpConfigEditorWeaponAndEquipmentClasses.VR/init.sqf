TEST_IncludedAuthors = ["anitsoy","awar","awar & el tyranos","awar & lennard","crotmoul","csa 38","csa38","el tyranos","el tyranos, pazel","i44 & ifa3 teams","i44 team","ifa3 team","kutejnikov","len","lennard","lib","lodu","lodu & el tyranos","lodu & tierprot","lodu, tierprot & shemich","luchador, el tyranos","stagler","tierprot","zver, el tyranos","reyhard & joarius"];
