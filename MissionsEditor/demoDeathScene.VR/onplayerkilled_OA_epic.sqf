BIS_fakeEnd =
{
	...
	_nil = createdialog "RscDisplayMissionEnd";

	waitUntil {!isNull (finddisplay 58)};
	_display = finddisplay 58;
	_buttonRetry = _display displayctrl 104;
	_buttonLoad = _display displayctrl 105;
	_buttonRestart = _display displayctrl 106;
	_buttonSwitch = _display displayctrl 107;
	_buttonCancel = _display displayctrl 2;

	_buttonRetry ctrlshow false;
	_buttonLoad ctrlshow false;
	_buttonRestart ctrlshow false;
	_buttonSwitch ctrlshow false;
	//_buttonCancel ctrlshow false;
