...
TEST_IncludedFactions = [];//"LIB_RKKA","LIB_NKVD","LIB_USSR_TANK_TROOPS","LIB_USSR_AIRFORCE","LIB_WEHRMACHT","LIB_PANZERWAFFE","LIB_LUFTWAFFE","LIB_FSJ","SG_STURMPANZER","SG_STURM","LIB_GUER","LIB_US_ARMY","LIB_US_TANK_TROOPS","LIB_US_AIRFORCE","LIB_US_101AB","LIB_US_82AB","LIB_DAK","LIB_NAC","LIB_US_RANGERS","LIB_UK_ARMY","LIB_CIV","LIB_FFI","LIB_MKHL","LIB_ARR","LIB_RBAF","LIB_RAF","LIB_RAAF","LIB_ACI","LIB_LUFTWAFFE_w","LIB_PANZERWAFFE_w","LIB_RKKA_w","LIB_UK_AB_W","LIB_UK_ARMY_W","LIB_US_AIRFORCE_w","LIB_US_ARMY_w","LIB_US_TANK_TROOPS_w","LIB_USSR_AIRFORCE_w","LIB_USSR_TANK_TROOPS_w","LIB_WEHRMACHT_w","SG_STURM_w"];
