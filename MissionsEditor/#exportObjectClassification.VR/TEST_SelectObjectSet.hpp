class TEST_SelectObjectSetDialog
{
	idd = 4712;
	movingEnable = false;
	onLoad = "['onLoad',_this,'TEST_SelectObjectSetDialog'] spawn TEST_fnc_initSelectObjectSetDialog;";
	controlsBackGround[] =
	{
		TemplateList,
//		ConfirmButton,
	...
	class TemplateList: RscListBox//RscListNBox//RscListBox
	{
		idc = 100;
		x = "(01/100) * SafeZoneW + SafeZoneX";
		y = "(01/100) * SafeZoneH + SafeZoneY";
		w = "(30/100) * SafeZoneW";
		h = "(98/100) * SafeZoneH";
...
//		onLBSelChanged = "hint str _this";
		onLBSelChanged = "_this spawn TEST_fnc_selectObjectSet";
//		onLBDblClick = "_this spawn TEST_fnc_selectObjectSet";
	};
...
//		action = "hint str _this";
		action = "_this spawn TEST_fnc_XXX;";
...
*/
	class CancelButton: RscButton//MenuCancel
	{
		idc = 2101;
		text = "Cancel";
		x = "(90/100) * SafeZoneW + SafeZoneX";
		y = "(94/100) * SafeZoneH + SafeZoneY";
		w = "(09/100) * SafeZoneW";
		h = "(05/100) * SafeZoneH";
