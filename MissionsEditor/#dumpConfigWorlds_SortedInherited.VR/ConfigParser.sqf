...
"ConfigDumpFileIO" callExtension format ["open:A3_%1_%2_Sorted_Inherited.cpp",_rootClassName,_className];
...
//		diag_log[_InheritedProperties];
	...
	if _sort then {
		_cfgClasses sort true;// call _fn_AlphaSortReversed;
		_cfgClasses call _fn_ReverseArray;
		_cfgEntries sort true;// call _fn_AlphaSort
	}
	else {
		_cfgClasses call _fn_ReverseArray};
