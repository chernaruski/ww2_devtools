...
for /F "Delims=" %%A in ('"dir config.cpp /b /s"') do (
	...
	"%APPPATH%\Rapify.exe" %LINTCHECKEXTENDED% "%%A" 2>>"%LOGPATH%\WW2_LintCheckExtended_TerrainsSource_Errors.log"  1>>"%LOGPATH%\WW2_LintCheckExtended_TerrainsSource_Console.log"
)
