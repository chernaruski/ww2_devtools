...
for /F "Delims=" %%A in ('"dir /a:d /b"') do (
	...
	echo %%A>>"%LOGPATH%\WW2_MakePboExternalsCheckAll_Console.log"
 	"%APPPATH%\MakePbo.exe" -QGJUP "%SOURCEPATH_WW2%\TerrainsSource_m\%%A" 2>>"%LOGPATH%\WW2_MakePboExternalsCheckAll_Errors.log"  1>>"%LOGPATH%\WW2_MakePboExternalsCheckAll_Console.log"
)
